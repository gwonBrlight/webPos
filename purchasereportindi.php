<div align="center">Purchase Report of:  <b><?php echo $_POST['daycusname']; ?></b>&nbsp;&nbsp;From:<strong> <?php echo $_POST['dayfrom']; ?></strong>&nbsp;&nbsp;To:<strong> <?php echo $_POST['dayto']; ?>
<br />
    </strong></div>
...
$result1 = mysql_query("SELECT * FROM stockinsumarry WHERE (supplier='$daycusname') AND (pdate BETWEEN '$a' AND '$b')");
...
?>  
<tr>
    <td colspan="2" style="border-color:#000000; border-style:solid; border-width:1px;"><div align="right"><strong>Grand Total</strong></div></td>
...
$result1 = mysql_query("SELECT sum(total) FROM stockinsumarry WHERE (supplier='$daycusname') AND (pdate BETWEEN '$a' AND '$b')");
while($row = mysql_fetch_array($result1))
{
    $rrr=$row['sum(total)'];
