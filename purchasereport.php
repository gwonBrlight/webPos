...
$result1 = mysqli_query($result1,"SELECT * FROM stockinsumarry WHERE pdate BETWEEN '$a' AND '$b'");
...
$result1 = mysqli_query($result1,"SELECT sum(total) FROM stockinsumarry WHERE pdate BETWEEN '$a' AND '$b'");
while($row = mysqli_fetch_array($result1))
{
    $rrr=$row['sum(total)'];
