...
$result1 = mysql_query("SELECT * FROM salessumarry WHERE (name='$daycusname') AND (date BETWEEN '$a' AND '$b')");
...
$result1 = mysql_query("SELECT sum(total) FROM salessumarry WHERE (name='$daycusname') AND (date BETWEEN '$a' AND '$b')");
while($row = mysql_fetch_array($result1))
{
    $rrr=$row['sum(total)'];
